...
import ProductCard from "../components/ProductCard"; // Corrected default import
    ...
    <div className="mt-12">
        ...
        <div className="text-sm w-full md:w-1/2">
          ...
          <div className="flex items-center mt-10 gap-4 text-base">
            ...
            <button
              ...
              className="w-full py-3.5 cursor-pointer font-medium bg-indigo-500 text-white hover:bg-green-600 transition"
            >
              Buy now
            </button>
          </div>
      ...
      <div className="flex flex-col items-center mt-20">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 md:gap-6 mt-6 w-full">
          {relatedProducts
            .filter((related) => related.inStock)
            .map((related, index) => (
