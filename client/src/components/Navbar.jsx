    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <NavLink to='/' onClick={() => setOpen(false)}>
                <img className="h-25 w-25" src={assets.logo} alt="logo" />
            </NavLink>
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                {/* Search Bar + Seller/Admin Button */}
                <div className="hidden lg:flex items-center text-sm gap-2">
                    ...
                    <button
                        ...
                        className="ml-2 px-3 py-1.5 border border-gray-400 rounded-full text-sm hover:bg-gray-100 transition"
                    >
                        Seller/Admin Login
                    </button>
                </div>
                ...
                {!user ? (
                    ...
                    <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-pink-200 py-2.5 w-30 rounded-md text-sm z-40'>
            ...
            {open && (
                <div className="absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden">
                    ...
                    <NavLink to="/seller" onClick={() => setOpen(false)}> Seller/Admin Login </NavLink>
                    {!user ? (
                        <button onClick={() => {
                            setOpen(false);
